...
public class SmithingTableRecipeCreatorTile extends LockableTileEntity
{
	...
	{
		super(InitTileEntities.SMITHING_TABLE_RECIPE_CREATOR.get());
	}
	...
	{
		return new SmithingTableRecipeCreatorContainer(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(getPos()));
	}
}