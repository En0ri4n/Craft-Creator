...
public class RecipeInfos implements NBTSerializable
{
    ...
    public CompoundNBT serialize()
    {
        ...
        {
            CompoundNBT parameterCompound = new CompoundNBT();
            ...
            switch(parameter.getType())
            {
                ...
                case INT_LIST:
                    ...
                    IntArrayNBT arrayNBT = new IntArrayNBT(intList.getList());
    ...
    public static RecipeInfos deserialize(CompoundNBT compound)
    {
        RecipeInfos recipeInfos = RecipeInfos.create();

        for(String keys : compound.getAllKeys())
        {
            CompoundNBT parameterCompound = compound.getCompound(keys);
            ...
            switch(type)
            {
                ...
                case BOOLEAN:
                    ...
                    break;
                case INT_LIST:
                    IntArrayNBT arrayNBT = (IntArrayNBT) parameterCompound.get("value");
                    ...
                    break;
                case MAP:
                    CompoundNBT nbt = parameterCompound.getCompound("value");
