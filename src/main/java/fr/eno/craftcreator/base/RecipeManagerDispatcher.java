...
public class RecipeManagerDispatcher
{
     ...
     */
    public static void createRecipe(SupportedMods mod, RecipeCreator recipe, TileEntity tileEntity, List<Slot> slots, RecipeInfos recipeInfos, ModRecipeSerializer.SerializerType serializerType)
    {
        switch(mod)
        {
            case BOTANIA:
