...
public abstract class MultiScreenModRecipeCreatorScreen<T extends CommonContainer> extends TaggeableSlotsContainerScreen<T>
{
    ...
    protected void renderLabels(MatrixStack matrixStack, int pMouseX, int pMouseY)
    {
        ...
        if(Screen.hasShiftDown() || Screen.hasControlDown()) drawString(matrixStack, this.font, References.getTranslate("screen.crafting.info.msg").getString(), getMessagePosX(), this.imageHeight + (isVanillaScreen ? 15 : 0), 0x707370);
    }
