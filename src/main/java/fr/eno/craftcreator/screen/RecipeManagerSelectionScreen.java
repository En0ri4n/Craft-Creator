...
public class RecipeManagerSelectionScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        this.addButton(new SimpleButton(References.getTranslate("screen.recipe_manager_selection.add_manager"), 10, 10, 100, 30, button -> ClientUtils.openScreen(new ModSelectionScreen())));
    }
