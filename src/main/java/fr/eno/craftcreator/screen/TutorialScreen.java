...
public class TutorialScreen extends Screen
{
    ...
    {
        super(new TextComponent("screen.tutorial.title"));
    }
    ...
    protected void init()
    {
        ...
        addRenderableWidget(previousButton = new SimpleButton(References.getTranslate("screen.button.previous"), width / 2 - backWidth / 2 - buttonWidth - gapX, height - buttonHeight - 20, buttonWidth, buttonHeight, b -> previousPage()));
        addRenderableWidget(nextButton = new SimpleButton(References.getTranslate("screen.button.next"), width / 2 + backWidth / 2 + gapX, height - buttonHeight - 20, buttonWidth, buttonHeight, b -> nextPage()));

        addRenderableWidget(new SimpleButton(References.getTranslate("screen.button.back"), width / 2 - backWidth / 2, height - buttonHeight - 20, backWidth, buttonHeight, b -> ClientUtils.openScreen(null)));
