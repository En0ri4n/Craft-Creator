...
{
    // Minecraft
    CRAFTING_TABLE(SupportedMods.MINECRAFT, RecipeType.CRAFTING, Utils.getGuiContainerTexture(SupportedMods.MINECRAFT.getModId(), "crafting_table_recipe_creator.png"), SlotHelper.CRAFTING_TABLE_SLOTS),
    FURNACE_SMELTING(SupportedMods.MINECRAFT, RecipeType.SMELTING, Utils.getGuiContainerTexture(SupportedMods.MINECRAFT.getModId(), "furnace_recipe_creator.png"), SlotHelper.FURNACE_SLOTS),
    FURNACE_BLASTING(SupportedMods.MINECRAFT, RecipeType.BLASTING, Utils.getGuiContainerTexture(SupportedMods.MINECRAFT.getModId(), "furnace_recipe_creator.png"), SlotHelper.FURNACE_SLOTS),
    FURNACE_SMOKING(SupportedMods.MINECRAFT, RecipeType.SMOKING, Utils.getGuiContainerTexture(SupportedMods.MINECRAFT.getModId(), "furnace_recipe_creator.png"), SlotHelper.FURNACE_SLOTS),
    CAMPFIRE_COOKING(SupportedMods.MINECRAFT, RecipeType.CAMPFIRE_COOKING, Utils.getGuiContainerTexture(SupportedMods.MINECRAFT.getModId(), "furnace_recipe_creator.png"), SlotHelper.FURNACE_SLOTS),
    SMITHING_TABLE(SupportedMods.MINECRAFT, RecipeType.SMITHING, Utils.getGuiContainerTexture(SupportedMods.MINECRAFT.getModId(), "smithing_table_recipe_creator.png"), SlotHelper.SMITHING_TABLE_SLOTS),
    STONECUTTER(SupportedMods.MINECRAFT, RecipeType.STONECUTTING, Utils.getGuiContainerTexture(SupportedMods.MINECRAFT.getModId(), "stonecutter_recipe_creator.png"), SlotHelper.STONECUTTER_SLOTS),
