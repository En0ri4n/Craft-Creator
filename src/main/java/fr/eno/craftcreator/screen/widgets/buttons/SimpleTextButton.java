...
public class SimpleTextButton extends Button
{
	...
	public SimpleTextButton(Component content, int x, int y, int width, int height, OnPress onPress)
	{
		this(content, Collections.emptyList(), x, y, width, height, onPress);
	}

	public SimpleTextButton(Component content, List<Component> tooltips, int x, int y, int width, int height, OnPress onPress)
	{
