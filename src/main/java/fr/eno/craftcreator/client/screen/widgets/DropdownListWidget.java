...
public class DropdownListWidget<T extends DropdownListWidget.Entry<?>> extends SimpleListWidget
{
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        fill(matrixStack, this.dropdownFieldX, this.dropdownFieldY, this.dropdownFieldX + this.dropdownFieldWidth, this.dropdownFieldY + this.dropdownFieldHeight, 0xf2c3a942);
        fill(matrixStack, this.dropdownFieldX + 1, this.dropdownFieldY + 1, this.dropdownFieldX + this.dropdownFieldWidth - 1, this.dropdownFieldY + this.dropdownFieldHeight - 1, Color.DARK_GRAY.getRGB());
        int color = 0xFFFFFFFF;
        IFormattableTextComponent title = References.getTranslate("screen.widget.dropdown_list.entry.name", ScreenUtils.truncateString(dropdownFieldWidth - 10, getMessage().getString()));
    ...
    public static class StringEntry extends DropdownListWidget.Entry<String>
    {
        ...
        public void render(MatrixStack matrixStack, int index, int top, int left, int width, int itemHeight, int mouseX, int mouseY, boolean hovered, float partialTicks)
        {
            ...
            fill(matrixStack, left, top, left + width - 4, top + itemHeight, 0xFF585858);
