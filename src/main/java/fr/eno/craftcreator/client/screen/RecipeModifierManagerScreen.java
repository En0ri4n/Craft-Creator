...
import fr.eno.craftcreator.client.screen.container.base.TaggeableSlotsContainerScreen;
...
public class RecipeModifierManagerScreen extends TaggeableSlotsContainerScreen<RecipeModifierContainer> implements INamedContainerProvider
{
    ...
    {
        super(RecipeModifierContainer.create(ClientUtils.getClientPlayer()), ClientUtils.getClientPlayer().inventory, new StringTextComponent("Recipe Modifier Manager"));
