...
public class SlotHelper
{
    ...
    static
    {
        ...
        PRESS_SLOTS = list(
                PRESS_SLOTS_INPUT = toList(new PositionnedSlot(thermalSlots++, 22, 98), new DefinedPositionnedSlot(thermalSlots++, 83, 98, is -> is.getTags().anyMatch(tag -> tag.location().equals(CommonUtils.parse("thermal:crafting/dies"))))),
        ...
        CHILLER_SLOTS = list(
                CHILLER_SLOTS_INPUT = toList(new DefinedPositionnedSlot(thermalSlots++, 29, 98, is -> is.getItem() instanceof BucketItem), new DefinedPositionnedSlot(thermalSlots++, 83, 98, is -> is.getTags().anyMatch(tag -> tag.location().equals(CommonUtils.parse("thermal:crafting/casts"))))),
