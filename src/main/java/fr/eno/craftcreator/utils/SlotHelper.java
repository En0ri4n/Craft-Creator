...
public class SlotHelper
{
    ...
    static
    {
        ...
        // Press
        PRESS_SLOTS_INPUT = Arrays.asList(new PositionnedSlot(thermalSlots++, 22, 98), new DefinedPositionnedSlot(thermalSlots++, 83, 98, is -> is.getTags().anyMatch(tagkey -> tagkey.location().equals(ClientUtils.parse("thermal:crafting/dies")))));
        ...
        // Chiller
        CHILLER_SLOTS_INPUT = Arrays.asList(new DefinedPositionnedSlot(thermalSlots++, 29, 98, is -> is.getItem() instanceof BucketItem), new DefinedPositionnedSlot(thermalSlots++, 83, 98, is -> is.getTags().anyMatch(tagkey -> tagkey.location().equals(ClientUtils.parse("thermal:crafting/casts")))));
