...
public class SlotHelper
{
    ...
    static
    {
        ...
        int thermalSlots = 0;
        TREE_EXTRACTOR_SLOTS = Arrays.asList(new PositionnedSlot(thermalSlots++, 22, 98), new PositionnedSlot(thermalSlots++, 83, 93), new PositionnedSlot(thermalSlots++, 189, 72));
