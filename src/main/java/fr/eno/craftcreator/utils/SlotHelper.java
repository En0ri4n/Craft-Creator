...
public class SlotHelper
{
    ...
    static
    {
        ...
        PURE_DAISY_SLOTS_INPUT = Collections.singletonList(new PositionnedSlot(botaniaSlots++, 26, 53));
        PURE_DAISY_SLOTS_OUTPUT = Collections.singletonList(new PositionnedSlot(botaniaSlots++, 134, 53));
        ...
        BREWERY_SLOTS_OUTPUT = Collections.singletonList(new PositionnedSlot(botaniaSlots++, 134, 33));
        ...
        TREE_EXTRACTOR_SLOTS_OUTPUT = Collections.singletonList(new PositionnedSlot(thermalSlots++, 189, 72));
