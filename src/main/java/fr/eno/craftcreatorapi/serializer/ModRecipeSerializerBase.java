package fr.eno.craftcreatorapi.serializer;

import com.google.gson.*;
import fr.eno.craftcreatorapi.SupportedMods;
...
public abstract class ModRecipeSerializer
{
    ...
    public void removeRecipe(KubeJSRecipe kubeJSModifiedRecipe, SerializerType serializerType)
    {
    ...
    public void addModifiedRecipe(KubeJSRecipe kubeJSModifiedRecipe)
    {
     ...
     */
    protected void addRecipeTo(JsonObject recipeJson, RecipeType<?> recipeType, ResourceLocation result)
    {
        Feedback feedback;
     ...
     */
    public <C extends Container> void removeAddedRecipeFrom(SupportedMods mod, Recipe<C> recipe, SerializerType serializerType)
    {
        Feedback feedback;
     ...
     * (e.g. "type": "minecraft:smelting" for {@link net.minecraft.world.item.crafting.RecipeType#SMELTING})
     *
